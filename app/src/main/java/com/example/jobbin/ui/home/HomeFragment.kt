package com.example.jobbin.ui.home
...
class HomeFragment : Fragment() {
    ...
    private lateinit var arrayListJobs:ArrayList<ModelJobs>
    lateinit var imageJobs : Array<Int>
    lateinit var judulJobs : Array<String>
    lateinit var keteranganJobs : Array<String>
    lateinit var jamJobs : Array<String>
    lateinit var alamatJobs : Array<String>
    lateinit var waktuJobs : Array<String>
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        rvJobs = view.findViewById(R.id.rv_jobs_dashborad)
